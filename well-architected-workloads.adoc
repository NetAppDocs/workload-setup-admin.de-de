...
Es können auch benutzerdefinierte Regeln in einfacher Sprache erstellt werden, um die Umgebungen anhand der Standards Ihrer Organisation und der NetApp Best Practices zu validieren. Regeln lassen sich mit einem Probelauf testen und anschließend für die Ausführung in den Umgebungen terminieren. link:https://docs.netapp.com/us-en/console-well-architected/learn-custom-rules.html["Weitere Informationen zu benutzerdefinierten Regeln"^].
