...
Lambda Link-Konnektivität:: Lambda Link-Konnektivität ermöglicht die Erstellung einer Vertrauensbeziehung und Konnektivität zwischen einem Workload Factory Account und einem oder mehreren FSx for ONTAP Dateisystemen. Links ermöglichen die Überwachung und Verwaltung bestimmter Dateisystemfunktionen direkt über die ONTAP REST API-Aufrufe, die über die Amazon FSx for ONTAP API nicht verfügbar sind.
...
EDA Speicheroperationen:: Die EDA-Speicherprozesse (Electronic Design Automation) in der NetApp Workload Factory lassen sich durch Performance-Optimierung, Integration mit Ihrer IaC zur Automatisierung von Speicherparametern und Sicherstellung der Betriebsgesundheit effizienter gestalten.
...
NOTE: Kontoadministratoren können KI-Funktionen aktivieren oder deaktivieren. Wenn ein Administrator sie deaktiviert, steht der Ask Me KI-Assistent nicht zur Verfügung. link:manage-genai-features.html["Informationen zur Verwaltung von KI-Funktionen"].
...
link:https://docs.netapp.com/us-en/workload-fsx-ontap/links-overview.html["Weitere Informationen zu Links"^]
...
* *NetApp Terraform Provider*: Mit Terraform können Infrastruktur-Workflows erstellt und verwaltet werden, die in der Workload Factory Konsole generiert wurden.
