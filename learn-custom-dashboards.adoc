...
---
= Informationen zu benutzerdefinierten Dashboards in NetApp Workload Factory
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
link:manage-custom-dashboards.html#change-dashboard-visibility["Informationen zum Ändern der Dashboard-Sichtbarkeit"].
