...
Die folgende Berechtigung ist jetzt im _read_ Modus für Datenbanken verfügbar: `iam:SimulatePrincipalPolicy`. Die folgende Berechtigung ist jetzt im _Automate_ Modus für GenAI verfügbar: `bedrock:GetFoundationModel`.
