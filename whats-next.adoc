...
* https://docs.netapp.com/us-en/workload-builders/index.html["Arbeitslasten der Bauarbeiter"^]
+
Vereinfachen Sie die Nutzung und den Zugriff auf Softwareversionen durch die Ermöglichung der Instant-Clone-Integration mit Versionskontrollsystemen und CI/CD-Workflows und sparen Sie so Zeit und Ressourcen.
