...
. Wählen Sie für die Workload-Funktionen, die eine Auswahl an Berechtigungsstufen bieten (Lesen oder Automatisieren), den Berechtigungstyp aus, der mit diesen Zugangsdaten verfügbar sein wird.
