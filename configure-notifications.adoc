...
| Monatlicher Kostenbericht | Monatliche Kostenübersicht für Ihr Konto, die Ausgabentrends, ungewöhnliche Änderungen und die besten Einsparmöglichkeiten für FSx für ONTAP-Dateisysteme anzeigt. | Kostenbericht | Empfehlung | Allgemeine Lagerung | FSx für ONTAP -Dateisysteme 


| Replikationsverzögerung | Die Replikation dauert länger als erwartet. | Replikation | Kritisch | Allgemeine Lagerung | FSx für ONTAP -Dateisysteme 


| Die Erstellung des benutzerdefinierten Dashboards war erfolgreich | Ihr individuelles Dashboard wurde erfolgreich erstellt und ist bereit zur Anzeige. | Benutzerdefinierte Dashboards | Erfolg | Allgemeine Lagerung | Workload Factory Konto 


| Erstellung eines benutzerdefinierten Dashboards fehlgeschlagen | Workload Factory konnte Ihr benutzerdefiniertes Dashboard nicht erstellen. Das Dashboard kann erneut erstellt werden. | Benutzerdefinierte Dashboards | Fehler | Allgemeine Lagerung | Workload Factory Konto 
|===
